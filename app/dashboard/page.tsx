...
import { Monitor, Shield, AlertTriangle, Server, Calendar, TrendingDown, TrendingUp } from "lucide-react"
...
export default function DashboardPage() {
  ...
  const [alerts, setAlerts] = useState<Array<{ id: string; severity: string; title: string; message: string }>>([])
